...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wxada2d5a7f1f808cf',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '434edf497701dd209525f7fdafb26968',
  ...
  USERS: [
    {
      ...
      id: 'ok9Lp5xNVOiii4jsCUYUCkOykalk',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'dzRey-_R5ocHU3i4e__q756hQrLnoTPAxuj42EKyRCM',
      // 所在省份
      province: '湖南',
      // 所在城市
      city: '嘉禾',
  ...
  CALLBACK_USERS: [
    {
      ...
      id: 'ok9Lp5xMgBMVd5kgHyRdHfwEPV9g',
    }
    // 你可以不断按格式往下增加
    // ...
  ],
